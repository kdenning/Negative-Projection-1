...
ggplot(effects_ident_main, aes(MFQSelf_c, 
  ...
  scale_color_discrete("Identification", breaks = c(-1.42, 0, 1.42), 
                       labels = c("Weak identification \n (1 SD below)", 
                                  ...
                                  "High identification \n (1 SD above)")) +
  theme_minimal() +
  labs(title = "Trending main effect of projection by in-group identification",
       x = "MFQ respones for self",
       y = "MFQ responses for target")
...
ggplot(effects_ident_main, aes(MFQSelf_c, 
                               ...
                               group = Identification, 
                               color = Identification)) +
  geom_smooth(method = "lm", se = FALSE, size = .8, colour = "black",
...
#ggsave("figure2.png", device = "png", type = "cairo")
```
